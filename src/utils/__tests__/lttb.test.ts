...
describe('m4Float32', () => {
  ...
  it('should handle multiple buckets', () => {
    ...
    const yData = new Float32Array([
      10, 20, 0, 15, // bucket 0: first=10, last=15, min=0, max=20 -> [0, 1, 2, 3]
      5, 0, 100, 50  // bucket 1: first=5, last=50, min=0, max=100 -> [4, 5, 6, 7]
    ]);
    const threshold = 8;
  ...
  it('should preserve extrema across multiple buckets', () => {
    ...
    const yData = new Float32Array([
      0, 100, -100, 0, 0, // Bucket 0: [0, 4, 2, 1]
      0, 0, 500, -500, 0  // Bucket 1: [5, 9, 8, 7]
    ]);
