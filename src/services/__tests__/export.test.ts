...
describe("exportToSVG", () => {
	...
	it("should handle missing dataset or axis", () => {
		...
		const svgMissingDS = exportToSVG(
			mockDatasets,
			seriesMissingDS,
			mockXAxes,
			mockYAxes,
		...
		const svgMissingAxis = exportToSVG(
			mockDatasets,
			seriesMissingAxis,
			mockXAxes,
			mockYAxes,
	...
	it("should handle missing columns", () => {
		...
		const svgMissingCol = exportToSVG(
			datasetsMissingCol,
			mockSeries,
			mockXAxes,
			mockYAxes,
		...
		const svgMissingYCol = exportToSVG(
			mockDatasets,
			seriesMissingYCol,
			mockXAxes,
			mockYAxes,
