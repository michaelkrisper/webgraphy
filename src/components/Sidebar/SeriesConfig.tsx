...
function CirclePointIcon({ size }: { size: number }) {
	return (
		<Circle size={size} fill="currentColor" stroke="white" strokeWidth={1} />
	);
}

function SquarePointIcon({ size }: { size: number }) {
	return (
...
function CrossPointIcon({ size }: { size: number }) {
	return <X size={size + 2} strokeWidth={3} />;
}

function NonePointIcon({ size }: { size: number }) {
	return (
...
function pointIcon(style: PointStyle) {
	...
	switch (style) {
		case "circle":
			return <CirclePointIcon size={size} />;
		case "square":
			return <SquarePointIcon size={size} />;
		case "cross":
			return <CrossPointIcon size={size} />;
		case "none":
			return <NonePointIcon size={size} />;
	}
}
