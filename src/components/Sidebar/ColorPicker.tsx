				...
				createPortal(
					...
					>
						...
						<div
							...
							onMouseDown={(e) => {
								handleHueMove(e);
								const move = (me: MouseEvent) => handleHueMove(me);
								const up = () => {
						...
						<div
							...
							onMouseDown={(e) => {
								...
								const move = (me: MouseEvent) => handleBrightnessMove(me);
								const up = () => {
									document.removeEventListener("mousemove", move);
									document.removeEventListener("mouseup", up);
								};
						...
						>
							<div
								className="color-picker-brightness-cursor"
								style={{ left: `${hsl.l}%` }}
							/>
						</div>
